...
<div class="card-template">
  ...
  <div class="card-template-stats">
    ...
    <div class="card-template-stat">
      ...
      <span class="card-template-stat-values">
        ${cardEdition.circulationTemplates.map(circulationTemplate => (`<div>${circulationTemplate.foil ? 'Foil' : 'Normal'} &ndash; ${circulationTemplate.population_operator}${circulationTemplate.population.toLocaleString()}</div>`)).join('\n')}
      </span>
    </div>
  </div>
  <p>
